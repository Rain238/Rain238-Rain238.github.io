// build time:Wed Jan 03 2024 15:15:17 GMT+0800 (中国标准时间)
var e = {
    version: "0.2.5",
    hostname: "https://rainrem.top",
    root: "/",
    statics: "/",
    favicon: {normal: "images/favicon.ico", hidden: "images/failure.ico"},
    darkmode: false,
    auto_scroll: true,
    js: {
    ...
    loader: {start: false, "switch": false},
    search: {
        appID: "KU64N2M6E4",
        apiKey: "0c7b384e04d3e443a38ee08a548c3658",
        indexName: "RainSauce",
        hits: {per_page: 10}
    },
    valine: {
        appId: "d2mtJPW3wWYq2DBeSpYo9nYt-gzGzoHsz",
        appKey: "RH7alNkFHwdTn87QtJxdJkQ5",
        placeholder: "请注意文明发言哦 ο(=·ω＜=)☆kira",
        avatar: "wavatar",
        pageSize: 10,
        lang: "zh-CN",
        visitor: true,
        ...
        tagMember: {
            master: ["8362ff51ba3511aee05f8ae965c77478"],
            friend: null,
            investor: null,
            admin: ["a91c0d7de74fe161f586c2cdd142cb0b"],
            waifu: null
        }
    },
    quicklink: {timeout: 3e3, priority: true},
    audio: ["https://y.qq.com/n/yqq/playlist/8044308872.html"],
...
const N = u("#sidebar");
const O = u("#brand");
var j = u("#tool"), I, H, q, S;
var A = u("#search");
var R, P, _;
var D = window.innerHeight;
var z = window.innerWidth;
var W = 0, B = window.location.href;
var Y;
const F = lozad("img, [data-background-image]", {
    loaded: function (e) {
        e.addClass("lozaded")
    }
});
    ...
    document.addEventListener("visibilitychange", function () {
        switch (document.visibilityState) {
            case"hidden":
                ...
                if (e.loader.switch) U.show();
                clearTimeout(b);
                break;
            case"visible":
                u('[rel="icon"]').attr("href", m + e.favicon.normal);
                document.title = LOCAL.favicon.show;
                if (e.loader.switch) U.hide(1e3);
...
const ee = function (t) {
    ...
    if (a) n = u(decodeURI(a)); else {
        n = e.auto_scroll ? parseInt(d.get(B)) : 0
    }
    if (n) {
        c(n);
        W = 1
...
const ve = function () {
    ...
    k.addEventListener("click", U.vanish);
